    ...
    <div class="row p-2">
        <div class="col-sm-10 col-lg-10 col-md-10">
            <p class="card-title-desc">List of contractors showing below. We have
                <code> total {{$investor->count()}} investors</code> out of which <code>{{$investor->where('is_active',1)->count()}} investors</code>  are <code>active</code>.
            </p>
        </div>
        <div class="col-sm-2 col-lg-2 col-md-2">
            <div class="row">
                <a href="{{route('investor.create')}}" class="ml-auto btn btn-secondary px-4" title="Add investor"><i class="fas fa-user-plus font-size-16"></i></a>
            </div>
        </div>
    </div>
                ...
                <td>
                    <div class="dropdown align-content-center">
                        ...
                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton8">
                            <a class="dropdown-item" href="{{route('investor.edit',$investor->id)}}"><i class="fa fa-edit"></i><span class="text-alias"> Edit</span></a>
