...
@section('content')
    <div class="row p-2">
        <div class="col-sm-10 col-lg-10 col-md-10">
            <p class="card-title-desc">Enlisted materials showing below. We have
                <code> total {{$materials->count()}} materials</code>.
            </p>
        </div>
        <div class="col-sm-2 col-lg-2 col-md-2">
            <div class="row">
                <a href="{{route('material.create')}}" class="ml-auto btn btn-secondary px-4" title="Add material"><i class="fas fa-plus font-size-16"></i></a>
            </div>
        </div>
    </div>
                ...
                <td>
                    <div class="dropdown align-content-center">
                        ...
                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton8">
                            <a class="dropdown-item" href="{{route('material.edit',$material->id)}}"><i class="fa fa-edit"></i><span class="text-alias"> Edit</span></a>
