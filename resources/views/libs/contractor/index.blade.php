...
@endsection
@section('content')
    <a href="{{route('investor.create')}}">Create</a>
    ...
    <table style="width:100%">
        ...
        <tbody>
        @foreach($investor as $supplier)
            <tr>
                <td>
                    <a href="{{route('supplier.show',$investor->id)}}">
                        {{($investor->name)}}
                    </a>
                </td>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton8">
                            <a class="dropdown-item" href="{{route('supplier.edit',$investor->id)}}"><i class="fa fa-edit"></i><span class="text-alias"> edit</span></a>
                            <form action="{{route('supplier.destroy',$investor->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
