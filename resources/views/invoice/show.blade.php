...
@section('content')
    ...
    <div class="bg-soft-light border-dark h-25 p-2">
    ...
    <div class="row  mt-5">
        <div class="col-md-6">
            @if($invoice->is_checkin)
                <span class="font-size-14">Taka received by <b>{{$invoice->created_by}}</b></span>
            @else
                <span class="font-size-14">Taka paid by <b>{{$invoice->created_by}}</b></span>
            @endif
        </div>
        <div class="col-md-6">
            <div class="text-right">
